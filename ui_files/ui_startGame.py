...
#
# Created: Mon Feb 10 08:49:49 2014
...
class Ui_testGame(object):
    def setupUi(self, testGame):
        ...
        self.stackedWidget_2 = QtGui.QStackedWidget(testGame)
        ...
        self.horizontalLayout_16 = QtGui.QHBoxLayout(self.page_4)
        ...
        self.horizontalLayout_16.addWidget(self.labelGap)
        spacerItem16 = QtGui.QSpacerItem(219, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.horizontalLayout_4.addWidget(self.editLabel)
        ...
        self.horizontalLayout_4.addWidget(self.lineEditGap)
        ...
        self.horizontalLayout_5.addWidget(self.editLabel_2)
        ...
        self.horizontalLayout_5.addWidget(self.lineEditGap_2)
        ...
        self.horizontalLayout_6.addWidget(self.editLabel_3)
        ...
        self.horizontalLayout_6.addWidget(self.lineEditGap_3)
        ...
        self.horizontalLayout_7.addWidget(self.editLabel_4)
        ...
        self.horizontalLayout_7.addWidget(self.lineEditGap_4)
        ...
        self.horizontalLayout_8.addWidget(self.editLabel_5)
        ...
        self.horizontalLayout_8.addWidget(self.lineEditGap_5)
        ...
        self.horizontalLayout_9.addWidget(self.editLabel_6)
        ...
        self.horizontalLayout_9.addWidget(self.lineEditGap_6)
        ...
        self.horizontalLayout_10.addWidget(self.editLabel_7)
        ...
        self.horizontalLayout_10.addWidget(self.lineEditGap_7)
        ...
        self.horizontalLayout_11.addWidget(self.editLabel_8)
        ...
        self.horizontalLayout_11.addWidget(self.lineEditGap_8)
        ...
        self.horizontalLayout_12.addWidget(self.editLabel_9)
        ...
        self.horizontalLayout_12.addWidget(self.lineEditGap_9)
        ...
        self.horizontalLayout_13.addWidget(self.editLabel_10)
        ...
        self.horizontalLayout_13.addWidget(self.lineEditGap_10)
        ...
        self.horizontalLayout_14.addWidget(self.editLabel_11)
        ...
        self.horizontalLayout_14.addWidget(self.lineEditGap_11)
        ...
        self.horizontalLayout_15.addWidget(self.editLabel_12)
        ...
        self.horizontalLayout_15.addWidget(self.lineEditGap_12)
    ...
    def retranslateUi(self, testGame):
        ...
        self.labelGap.setText(_translate("testGame", "TextLabel", None))
        self.editLabel.setText(_translate("testGame", "1", None))
        self.editLabel_2.setText(_translate("testGame", "2", None))
        self.editLabel_3.setText(_translate("testGame", "3", None))
        self.editLabel_4.setText(_translate("testGame", "4", None))
        self.editLabel_5.setText(_translate("testGame", "5", None))
        self.editLabel_6.setText(_translate("testGame", "6", None))
        self.editLabel_7.setText(_translate("testGame", "7", None))
        self.editLabel_8.setText(_translate("testGame", "8", None))
        self.editLabel_9.setText(_translate("testGame", "9", None))
        self.editLabel_10.setText(_translate("testGame", "10", None))
        self.editLabel_11.setText(_translate("testGame", "11", None))
        self.editLabel_12.setText(_translate("testGame", "12", None))
