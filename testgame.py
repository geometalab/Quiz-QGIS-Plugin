...
class TestGame:
	...
	def run(self):
		...
		self.dlg.ui.dataMenu.setTitle(self.translator[self.language][32])
		self.dlg.ui.quizLoader.setText(self.translator[self.language][33])
		self.buttonList.append(self.dlg.ui.quizLoader)
		self.dlg.ui.results.setText(self.translator[self.language][34])
		self.buttonList.append(self.dlg.ui.results)
		self.dlg.ui.actionQuiz_starten.setText(self.translator[self.language][35])
		self.dlg.ui.actionQuiz_trainieren.setText(self.translator[self.language][2])
		self.dlg.ui.menuLetzte_Quizzes.setTitle(self.translator[self.language][36])
		...
		self.dlg.ui.quizLoader.triggered.connect(self.selectQuiz)
		self.dlg.ui.actionQuiz_starten.triggered.connect(self.startQuiz)
		self.dlg.ui.actionQuiz_trainieren.triggered.connect(self.training)
		self.dlg.ui.actionQuiz_trainieren.setEnabled(False)	
		self.dlg.ui.actionQuiz_starten.setEnabled(False)
